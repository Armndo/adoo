								...
								<form action="../Controller/ConsumidorController.php" method="post">
									...
									<div class="columns">
										<div class="column">
										  	...
										  	<div class="control">
								    			<input class="input" name="calle" type="text" required="" value="<?php echo $aux->getCalle() ?>">
										  	</div>
										</div>
										<div class="column">
										  	<label class="label">Número exterior</label>
										  	<div class="control">
								    			<input class="input" name="numext" type="text" required="" value="<?php echo $aux->getNumext() ?>">
										  	</div>
										</div>
										<div class="column">
										  	<label class="label">Número interior</label>
										  	<div class="control">
								    			<input class="input" name="numint" type="text" value="<?php echo $aux->getNumint() ?>">
										  	</div>
										</div>
									</div>
									<div class="columns">
										...
										<div class="column">
										  	...
										  	<div class="control">
								    			<input class="input" name="municipio" type="text" required="" value="<?php echo $aux->getMunicipio() ?>">
										  	</div>
										</div>
										<div class="column">
										  	<label class="label">Colonia</label>
										  	<div class="control">
								    			<input class="input" name="colonia" type="text" required="" value="<?php echo $aux->getColonia() ?>">
										  	</div>
										</div>
									</div>
									<div class="columns">
										<div class="column is-one-third">
										  	...
										  	<div class="control">
								    			<input class="input" name="cp" type="text" required="" value="<?php echo $aux->getCp() ?>">
										  	</div>
										</div>
									</div>
									<div class="columns">
