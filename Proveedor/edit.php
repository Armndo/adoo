								...
								<form action="../Controller/ProveedorController.php" method="post">
									...
									<div class="columns">
										<div class="column is-one-third">
										  	...
										  	<div class="control">
								    			<input class="input" type="text" disabled="" value="<?php echo $aux->usuario()->getEmail() ?>">
										  	</div>
										</div>
										<div class="column is-one-third">
										  	<label class="label">Contraseña</label>
										  	<div class="control">
								    			<input class="input" name="password" type="text" required="" value="<?php echo $aux->usuario()->getPassword() ?>">
										  	</div>
										</div>
									</div>
									...
									<div class="columns">
										<div class="column">
										  	...
										  	<div class="control">
								    			<input class="input" name="calle" type="text" required="" value="<?php echo $direccion->getCalle() ?>">
										  	</div>
										</div>
										<div class="column">
										  	<label class="label">Número exterior</label>
										  	<div class="control">
								    			<input class="input" name="numext" type="text" required="" value="<?php echo $direccion->getNumext() ?>">
										  	</div>
										</div>
										<div class="column">
										  	<label class="label">Número interior</label>
										  	<div class="control">
								    			<input class="input" name="numint" type="text" value="<?php echo $direccion->getNumint() ?>">
										  	</div>
										</div>
									</div>
									<div class="columns">
										...
										<div class="column">
										  	...
										  	<div class="control">
								    			<input class="input" name="municipio" type="text" required="" value="<?php echo $direccion->getMunicipio() ?>">
										  	</div>
										</div>
										<div class="column">
										  	<label class="label">Colonia</label>
										  	<div class="control">
								    			<input class="input" name="colonia" type="text" required="" value="<?php echo $direccion->getColonia() ?>">
										  	</div>
										</div>
									</div>
									<div class="columns">
										<div class="column is-one-third">
										  	...
										  	<div class="control">
								    			<input class="input" name="cp" type="text" required="" value="<?php echo $direccion->getCp() ?>">
										  	</div>
										</div>
									</div>
									<div class="columns">
